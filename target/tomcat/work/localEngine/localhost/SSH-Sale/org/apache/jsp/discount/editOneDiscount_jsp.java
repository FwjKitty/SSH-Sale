...
public final class editOneDiscount_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t$(\".a4\").attr(\"value\",$(this).val()-$(\".tdchange3\").text());\r\n");
      out.write("\t\t\t\t\t$(\".tdchange4\").text($(this).val()-$(\".tdchange3\").text());\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t})\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t})\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"a6\" type=\"hidden\" name=\"specialDiscount.discountId\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t value=\"");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"specialDiscount.appliedAmount\" value=\"");
      out.print(name2 );
      out.write("\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input class=\"a0\" type=\"hidden\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"specialDiscount.discountName\" value=\"");
      out.print(name );
      out.write("\" />  <input\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td class=\"tdchange4\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
      out.print(name3 );
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td class=\"tdchange5\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
      out.print(name4 );
      out.write("\r\n");
