...
public final class addNormalDiscount_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t}else if($(\"#discount\").val()==\"加价折扣\"){\r\n");
      ...
      out.write("\t\tif($(\".tdchange0\").text()==\"\"||$(\".tdchange0\").text().trim()==\"\"){\r\n");
      out.write("\t\t\talert(\"折扣名称不能为空\");\r\n");
      out.write("\t\t\treturn false;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\telse if($(\".tdchange2\").text()==\"\"||$(\".tdchange2\").text().trim()==\"\"){\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"normalDiscount.discountName\" value=\"\"/> <input class=\"a1\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\ttype=\"hidden\" name=\"normalDiscount.baseQty\" value=\"\"/> <input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"a2\" type=\"hidden\" name=\"normalDiscount.discountRate\" value=\"\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input class=\"a3\" type=\"hidden\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"normalDiscount.activity\" value=\"是\" /> <input\r\n");
