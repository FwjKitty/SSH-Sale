...
public final class showNormalDiscount_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.print(request.getContextPath());
      out.write("/NormalDiscountAction!query.action?name=\"+name+\"&type=\"+type;\r\n");
      ...
      out.write("\t\t\t\t\t\t\tvar row = \"<tr><td>序号</td><td>折扣名称</td><td>折扣类型</td><td>折扣基准</td><td>折扣数量（片）</td><td>折扣率</td><td>有效</td><td>操作</td></tr>\";\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t$\r\n");
      out.write("\t\t\t\t\t\t\t\t\t.each(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tdata,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"</td><td>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ entry.discountBase\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"</td><td>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ entry.baseQty\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"</td><td>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ entry.discountRate\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"</td><td>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ entry.activity\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"</td><td><a type='button' class='btn btn-success' id=\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ entry.normalId\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ \" href='");
      out.print(request.getContextPath());
      out.write("/discount/addNormalDiscount.jsp?id=\"+entry.normalId+\"&discountName=\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t+entry.discountName+\"&discountBase=\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t+entry.discountBase+\"&type=\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t+entry.type+\"&baseQty=\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t+entry.baseQty+\"&discountRate=\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t+entry.discountRate+\"&activity=\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t+entry.activity+\"'>编辑</td></tr>\";\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t});\r\n");
      out.write("\r\n");
      ...
      out.write("\t\tvar urlGet =\"");
      out.print(request.getContextPath());
      out.write("/NormalDiscountAction!showPage.action?curPage=\" + curPage1;\r\n");
      out.write("\t\t//$(\"#customer\").html(\"\");\r\n");
      out.write("\r\n");
      out.write("\t\t$\r\n");
      out.write("\t\t\t\t.getJSON(\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ \" href='");
      out.print(request.getContextPath());
      out.write("/discount/editNormalDiscount.jsp?id=\"+entry.normalId+\"&discountName=\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t+entry.discountName.replace('%','%25')+\"&discountBase=\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t+entry.discountBase+\"&type=\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t+entry.type+\"&baseQty=\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t+entry.baseQty+\"&discountRate=\" \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t+entry.discountRate+\"&activity=\"\r\n");
      ...
      out.write("\t\t\t\t<a href=\"loginActiona!out.action\" class=\"btn btn-success\"\r\n");
      ...
      out.write("                        <a class=\"accordion-toggle\">发货单管理</a>\r\n");
      out.write("                    </div>\r\n");
      out.write("                    <div id=\"collapseTwo\" class=\"panel-collapse collapse \"\r\n");
      out.write("                        style=\"height: auto;\">\r\n");
      out.write("                        <div class=\"panel-body\">\r\n");
      out.write("                            <ul class=\"nav nav-pills nav-stacked\">\r\n");
      out.write("                                <li><a href=\"#\">SQL基础</a></li>\r\n");
      out.write("                                <li><a href=\"#\">Oracle</a></li>\r\n");
      out.write("                                <li><a href=\"#\">MySQL</a></li>\r\n");
      out.write("                            </ul>\r\n");
      out.write("                        </div>\r\n");
      out.write("                    </div>\r\n");
      out.write("                </div>\r\n");
      ...
      out.write("                                <li><a href=\"javascript:void(0)\" onclick=\"getPriceListPage(1)\">价格表管理</a></li>\r\n");
      out.write("                            </ul>\r\n");
      out.write("                        </div>\r\n");
      out.write("                     </div>\r\n");
      out.write("                  </div>\r\n");
      ...
      out.write("                                                <label class=\"input-group-addon\" id=\"basic-addon4\" style=\"width: 99px\"  >类型</label>\r\n");
      out.write("\r\n");
      out.write("                                                    <select class=\"input-xlarge\" id=\"sl\" style=\"width: 350px;height: 34px\" id=\"select1\">\r\n");
      out.write("                                                        <option selected=\"selected\">全部类型</option>\r\n");
      ...
      out.print(request.getContextPath());
      out.write("/discount/addNormalDiscount.jsp?id=&discountName=&discountBase=金额&type=一般折扣&baseQty=&discountRate=&activity=是'\">新增</button>\r\n");
