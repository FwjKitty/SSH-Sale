...
<script type="text/javascript">
	...
	function NewCustomersInfo(){
		...
		var status=document.getElementById("address10").value;
		
		var city=document.getElementById("address3").value;
		var mu=document.getElementById("address8").value;
		var mai=document.getElementById("address9").value;
	...
	alert("是否确认保存？")
	document.temp.action = "UpdateAction?country="+v+"&customerId="+${customer.customerId};
...
<body>
	...
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="#" style="color: red"><h3
				style="line-height: 0">主页面维护>客户管理>编辑客户</h3> </a>
	</div>
	<%-- <div>
				...
				<div class="row">
					<form  id="form1"  name="temp" class="form-horizontal" role="form"  action=""  method="post"> 
									<div class="form-group">
							            ...
							            <div class="col-sm-2">
							                <input  id="text1" type="text" name="customerName" class="form-control"  value="${customer.customerName}"/>
							            </div>
							            <label class="col-sm-2 control-label">类型</label>
							            <div class="col-sm-2">
							                <input  id="text2" type="text" name="type" class="form-control"  value="${customer.type}" />
							            </div>
							             <label  id="test3" class="col-sm-2 control-label">集团公司</label>
							            <div class="col-sm-2">
							                <input id="text3" type="text" name="groupCompany" class="form-control"  value="${customer.groupCompany}"/>
							            </div>
							            ...
							            <div class="col-sm-2">
							                <input id="text4" type="text" name="customerCode" class="form-control" value="${customer.type}"/>
							            </div>
							            ...
							            <div class="col-sm-2">
							                ...
							                <input id="text5" disabled type="text" name="status" class="form-control" value="${address.status}"/>
							            </div>
							             <label class="col-sm-2 control-label">总公司</label>
							            <div class="col-sm-2">
							                <input id="text6" type="text" name="corporation" class="form-control" value="${customer.corporation}" />
							            </div>
					...
					<!--<div class="col-md-12" >
						...
						<!-- <form action="" id="form3" class="form-horizontal" role="form"   method="post"> -->
								<div class="form-group">
							            ...
							            <div class="col-sm-3">
							                <input  id="payment1" type="text" name="invoiceGroup" class="form-control" value="${address.postcode}"/>
							            </div>
							              <label class="col-sm-2 control-label">* 通用加价条款</label>
							            <div class="col-sm-3">
							                <input id="payment2"  type="text" name="markupName" class="form-control" value="${address.postcode}"/>
							            </div>
							    </div>
							    <div class="form-group">
							            <label class="col-sm-2 control-label">* 结算货币</label>
							            <div class="col-sm-3">
							                <input id="payment3" type="text" name="currency" class="form-control" value="${payment.currency}"/>
							            </div>
							              <label class="col-sm-2 control-label">* 一般折扣</label>
							            <div class="col-sm-3">
							                <input id="payment4"  type="text" name="discountName" class="form-control" value="${payment.discountName}"/>
							            </div>
							    </div>
							   <div class="form-group">
							            <label class="col-sm-2 control-label">* 付款方式</label>
							            <div class="col-sm-4">
							                <input id="payment5"  type="text" name="paymentTerm" class="form-control" value="${payment.paymentTerm}"/>
							    		</div>
							  </div>
							   <div class="form-group">
							            <label class="col-sm-2 control-label" >* 价格条款1</label>
							            <div class="col-sm-4" >
							               <textarea id="payment6"  rows="4" name="priceTerm1" class="form-control">${payment.priceTerm1}</textarea>
							    		</div>
							  </div>
							    <div class="form-group">
							            ...
							            <div class="col-sm-4">
							               ...
							               <textarea id="payment7"  class="form-control" rows="4"  name="priceTerm2">${payment.priceTerm2}</textarea>
							    		</div>
							  </div>
							    <div class="form-group">
							         <label class="col-sm-2 control-label">* 价格条款3</label>
							        <div class="col-sm-4">
							               <textarea id="payment8"  class="form-control" rows="4"  name="priceTerm3">${payment.priceTerm3}</textarea>
							    	</div>
							  </div>
						  <div class="form-group">
							            <div class="col-sm-offset-10 col-sm-2">
							                 <button id="paymentbutton" type="submit"  class="btn btn-info" onclick="return NewCustomersInfo()">
							                   	保存
							                </button>
							     		</div>              
							 	</div>
						...
						<!-- <form action="" id="form4" class="form-horizontal" role="form"   method="post"> -->
								<div class="form-group">
							            ...
							            <div class="col-sm-2">
							                <input id="o1"  type="text" name="marketArea" class="form-control" value="${organization.marketArea}"/>
							            </div>
							    </div>
							    <div class="form-group">
							            <label class="col-sm-2 control-label">* 业务经理</label>
							            <div class="col-sm-2">
							                <input id="o2"  type="text" name="businessManager" class="form-control" value="${organization.businessManager}"/>
							            </div>
							    </div>
							      <div class="form-group">
							            <label class="col-sm-2 control-label">* 业务助理</label>
							            <div class="col-sm-2">
							                <input id="o3"  type="text" name="businessAssistant" class="form-control" value="${organization.businessAssistant}"/>
							            </div>
							    </div>
								     <div class="form-group">
							            <div class="col-sm-offset-10 col-sm-2">
					...
					<!-- 	</form> -->
						...
						<!-- <form action="" id="form5" class="form-horizontal" role="form"   method="post"> -->
								<div class="form-group">
							            ...
							            <div class="col-sm-3">
							                <input id="mail1"  type="text" name="mailFrom" class="form-control" value="${contactors.mailFrom}"/>
							            </div>
							    </div>
							    <div class="form-group">
							            <label class="col-sm-2 control-label">Pre Po收件人</label>
							            <div class="col-sm-3">
							                <input  id="mail2" type="text" name="prePoMailTo" class="form-control" value="${contactors.prePoMailTo}"/>
							            </div>
							    </div>
							    <div class="form-group">
							            <label class="col-sm-2 control-label">Po 收件人</label>
							            <div class="col-sm-3">
							                <input id="mail3"  type="text" name="poMailTo" class="form-control" value="${contactors.poMailTo}"/>
							            </div>
							    </div>
							    <div class="form-group">
							            <label class="col-sm-2 control-label">OC/PI收件人</label>
							            <div class="col-sm-3">
							                <input  id="mail4" type="text" name="ocpiMailTo" class="form-control" value="${contactors.ocpiMailTo}"/>
							            </div>
							    </div>
							    <div class="form-group">
							            <label class="col-sm-2 control-label">INV/Packing list 收件人</label>
							            <div class="col-sm-3">
							                <input id="mail5"  type="text" name="invPklistMailto" class="form-control" value="${contactors.invPklistMailto}"/>
							            </div>
							    </div>
							     <div class="form-group">
							            <div class="col-sm-offset-10 col-sm-2">
				...
				<div class="row">
					<form  id="form1"  name="temp" class="form-horizontal" role="form"  action=""  method="post"> 
									<div class="form-group">
							            ...
							            <label class="col-sm-2 control-label">* 客户简称</label>
							            <div class="col-sm-2">
							                <input id="text4" type="text" name="customerCode" class="form-control" value="${customer.customerCode}" />
							            </div>
							            <label class="col-sm-2 control-label">* 状态</label>
							            <div class="col-sm-2">
							                <input id="text5" type="text" name="status" class="form-control" value="${address.status}" />
							            </div>
							             <label class="col-sm-2 control-label">总公司</label>
							            <div class="col-sm-2">
							                <input id="text6" type="text" name="corporation" class="form-control" value="${customer.corporation}" />
					...
					<!-- <div class="col-md-12" >
						...
						<form action="" name="form2" id="form2" class="form-horizontal" role="form"   method="post"> -->
							    ...
							    <div class="form-group">
							            <label class="col-sm-2 control-label">州/省</label>
							            <div class="col-sm-3">
							                <input  id="address4" type="text" name="state" class="form-control" value="${address.state}"/>
							            </div>
							    </div>
							   <div class="form-group">
							            <label class="col-sm-2 control-label">* 国家</label>
							      ...
							      <div class="form-group">
							            <label class="col-sm-2 control-label" >邮编</label>
							            <div class="col-sm-2">
							                <input  id="address6" type="text" name="postcode" class="form-control" value="${address.postcode}" />
							            </div>
							    </div>
							      <div class="form-group">
							            <label class="col-sm-2 control-label">* 目的港</label>
							            <div class="col-sm-2">
							                <input  id="address7" type="text" name="portOfDestination" class="form-control" value="${address.portOfDestination}" />
							            </div>
							    </div>
							      <div class="form-group">
							            <label class="col-sm-2 control-label">* 唛头</label>
							            <div class="col-sm-4">
							                <input  id="address8" type="text" name="shippingMark" class="form-control" value="${address.shippingMark}" />
							            </div>
							    </div>
							      <div class="form-group">
							            <label class="col-sm-2 control-label">有效</label>
							            <div class="col-sm-2">
							                <input  id="address9" type="text" name="status" class="form-control" value="${address.status}"/>
							            </div>
							    </div>
							      <div class="form-group">
							            <label class="col-sm-2 control-label">失效日期</label>
							            <div class="col-sm-2">
							                <input  id="address10" type="text" name="inactiveDate" class="form-control" value="${address.inactiveDate}" />
							            </div>
							    </div>
							    <div class="form-group">
							            <div class="col-sm-offset-10 col-sm-2">
						...
						<!-- <form action="" id="form3" class="form-horizontal" role="form"   method="post"> -->
								<div class="form-group">
							            <label class="col-sm-2 control-label"> 所属发票组</label>
							            <div class="col-sm-3">
							                <input  id="payment1" type="text" name="invoiceGroup" class="form-control" value="${payment.invoiceGroup}"/>
							            </div>
							              <label class="col-sm-2 control-label">* 通用加价条款</label>
							            <div class="col-sm-3">
							                <input  id="payment2" type="text" name="markupName" class="form-control" value="${payment.markupName}"/>
							            </div>
							    </div>
							    <div class="form-group">
							            <label class="col-sm-2 control-label">* 结算货币</label>
							   ...
							   <div class="form-group">
							            <label class="col-sm-2 control-label" > 价格条款1</label>
							            <div class="col-sm-4">
							               <textarea id="payment6" class="form-control" rows="4" name="priceTerm1" >${payment.priceTerm1}</textarea>
							    		</div>
							  </div>
							    <div class="form-group">
							            <label class="col-sm-2 control-label"> 价格条款2</label>
