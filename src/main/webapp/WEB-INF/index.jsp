...
<script type="text/javascript">
	...
	function getCustomer(curPage1) {
		var urlGet = "CustomerAction!showPage.action?curPage=" + curPage1;
		//$("#customer").html("");
...
<body>
		...
		<form class="navbar-form navbar-right" role="search">
			<div class="form-group">
				<a href="loginActiona!out.action" class="btn btn-success"
					role="button" style="margin-right: 20px"><%=session.getAttribute("username")%>
					<br/>退出
				</a>
		...
		<div class="container-fluid panel1" style="height: 950px;width:1800px">
			<div class="row-fluid ">
				<div class="col-md-2 " style="height: 950px;width:260px">
					<!--Sidebar content-->
					<!--竖直导航-->
					<ul class="nav nav-pills nav-l">
						<li class="active "><a href="#" onclick="getCustomer(1)">
							<span class=" glyphicon glyphicon-stop "></span>
							客户管理
							<i class="glyphicon glyphicon-chevron-right" style="margin-left: 105px">
							</i>
						</a></li>
						<li><a href="index.jsp">
							<span class=" glyphicon glyphicon-stop "></span>
							电影管理
							<span class="glyphicon glyphicon-chevron-right" style="margin-left: 105px">
							</span>
						</a></li>									
					</ul>
				</div>
	...
	<div class="modal fade myModal2" id="model6" tabindex="-1" role="dialog" aria-hidden="true">
