...
<script type="text/javascript">
	...
	alert("请将填写余下表单，带*号为必填项");
		var d=document.all.form2.abc;
		var v=d.options[d.selectedIndex].value;
		
		document.form2.action = "CustomerAddAction?country="+v;
...
<!-- 						<table class="table table-stripeed table-bordered table-hover" id="table1">	
						...
						<form action="" id="form3" class="form-horizontal" role="form"   method="post">
								<div class="form-group">
							            ...
							            <div class="col-sm-3">
							                <input  id="payment1" type="text" name="invoiceGroup" class="form-control" name="xxxxx"/>
							            </div>
							              <label class="col-sm-2 control-label">* 通用加价条款</label>
							            <div class="col-sm-3">
							                <input  id="payment2" type="text" name="markupName" class="form-control" name="低于50片加价5%"/>
							            </div>
							    </div>
							    <div class="form-group">
							            <label class="col-sm-2 control-label">* 结算货币</label>
							            <div class="col-sm-3">
							                <input id="payment3" type="text" name="currency" class="form-control" name="USD"/>
							            </div>
							              <label class="col-sm-2 control-label">* 一般折扣</label>
							            <div class="col-sm-3">
							                <input  id="payment4" type="text" name="discountName" class="form-control" name="3%折扣"/>
							            </div>
							    </div>
							   <div class="form-group">
							            <label class="col-sm-2 control-label">* 付款方式</label>
							            <div class="col-sm-4">
							                <input id="payment5"  type="text" name="paymentTerm" class="form-control" name="60天后付款"/>
							    		</div>
							  </div>
							   <div class="form-group">
