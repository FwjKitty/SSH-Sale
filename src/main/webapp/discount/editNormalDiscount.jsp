									...
									<div class="panel-body ">
										...
										<form class="form-horizontal well"
											...
											<fieldset>
													...
													name="normalDiscount.discountName" value="<%=name0%>"/> 
													<input class="a1"
													type="hidden" name="normalDiscount.baseQty" value="<%=name3%>"/> 
													<input
													class="a2" type="hidden" name="normalDiscount.discountRate" value="<%=name4%>" />
													<input class="a3" type="hidden"
													name="normalDiscount.activity" value="<%=name5%>" /> 
